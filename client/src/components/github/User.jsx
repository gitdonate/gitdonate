...
class User extends Component {
    ...
    */
    fetchData() {
        //jesse oauth token: 9b6e73686a7cf06585e9acad5ec28140bdb0ea7f
        fetch(`https://api.github.com/users/${this.props.match.params['username']}?access_token=9b6e73686a7cf06585e9acad5ec28140bdb0ea7f`)
